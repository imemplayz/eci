...
function Navbar() {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    const matchingAdmin = admin.find(
  ...
  return (
    <>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex justify-end">
                      <div
                        className="bg-gray-400/25 text-gray-500 py-2 px-3 rounded-full mt-4 w-fit flex items-center gap-2 cursor-pointer hover:bg-gray-400/50 transition-all ease-in-out duration-150"
                        onClick={handleLogin}
                      >
                        <p>Proceed</p>
                        <FaArrowRight />
      ...
      <AnimatePresence initial={false} mode="wait">
        {modalOpen && (
          <InfoModal modalOpen={modalOpen} handleClose={closeModal} />
        )}
      </AnimatePresence>
    </>
  );
